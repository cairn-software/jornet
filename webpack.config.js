...
const properties = {
  googleMapsKey: process.env.JORNET_GOOGLE_MAPS_KEY,
  stravaClientId: process.env.JORNET_STRAVA_CLIENT_ID,
  stravaClientSecret: process.env.JORNET_STRAVA_CLIENT_SECRET,
  redirectUri: process.env.JORNET_REDIRECT_URL,
};
