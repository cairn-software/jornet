...
mockery.registerMock('properties', {
  ...
  dbConnectionString: `postgres://${process.env.JORNET_DB_USER}@${process.env.JORNET_DB_HOST}:${process.env.JORNET_DB_PORT}/jornet?connect_timeout=10&application_name=myapp`,
});
